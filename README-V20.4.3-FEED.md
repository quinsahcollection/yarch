# Yarch V20.4.3 — Feed, Comments & Video Thumbnails
...
- Deploy `firestore-rules-yarch-v20.4.3.rules` sebelum memakai Feed, komentar, dan tombol ikuti.
...
1. Publikasikan `firestore-rules-yarch-v20.4.3.rules` melalui Firebase Console atau Firebase CLI.
